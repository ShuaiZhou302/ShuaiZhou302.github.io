...
(function () {
  const I18N = {
    zh: {
      ...
      "intro.p3": "EgoANT 是一套面向第一视角人类操作视频的自动标注管线，用于将长视频划分为动作级片段，并为每个片段生成简洁的操作描述。EgoANT 在 WGO-Bench 的第一视角人类操作基准子集 HomER 的 25 个视频 / 470 个参考片段上，最佳分段配置取得 Segment F1 0.2031；固定参考边界下的纯标注 Label Acc 达 55.7%；纯视频输入的端到端方案取得总分 Semantic E2E F1 0.1542。据此形成了一套相对廉价、基于开源视觉语言模型的第一视角子任务自动标注系统。",
