...
(function () {
  const I18N = {
    zh: {
      ...
      "hero.link.app": "附录细节",
      "hero.eyebrow": "用开源视觉语言模型标注第一视角人类视频",
      "hero.lede": "EgoANT 是一套面向第一视角人类操作视频的自动标注管线，用于将长视频划分为动作级片段，并为每个片段生成简洁的操作描述。EgoANT 在 WGO-Bench 的第一视角人类操作基准子集 HomER 的 25 个视频 / 470 个参考片段上，最佳分段配置取得 Segment F1 0.2031；固定参考边界下的纯标注 Label Acc 达 55.7%；纯视频输入的端到端方案取得总分 Semantic E2E F1 0.1542。据此形成了一套相对廉价、基于开源视觉语言模型的第一视角子任务自动标注系统。",
      "en.banner": "",
    ...
    en: {
      ...
      "hero.eyebrow": "Annotating Egocentric Human Video with open-source VLM",
      "hero.lede": "EgoANT is an automatic annotation pipeline for egocentric human manipulation video: it cuts long videos into action-level segments and writes a short operation label for each. On HomER—the egocentric human subset of WGO-Bench (25 episodes / 470 gold segments)—the best segmentation setup reaches Segment F1 0.2031; under fixed reference boundaries, pure labeling reaches Label Acc 55.7%; the pure-video end-to-end pipeline reaches overall Semantic E2E F1 0.1542. Together this yields a relatively inexpensive open-source-VLM system for egocentric subtask annotation.",
      "en.banner": "",
      ...
      "splash.link.home": "Back to homepage"
    },
  };
