...
(function () {
  const I18N = {
    zh: {
      ...
      "story.label.7": "邻段拼贴 · 397B：用上文「邻段拼贴」。",
      "story.label.8": "邻段拼贴 + 秒级时间戳 · 397B：在上文「邻段拼贴」上为每格加入秒级时间戳后重跑。",
      "story.label.9": "近似手部拼贴 · 397B：用 YOLO 或画面中心启发式裁剪手部区域后拼图提交。",
    ...
    en: {
      ...
      "story.label.7": "Neighbor collage · 397B: use the neighbor-collage input above.",
      ...
      "story.label.9": "Approximate hand collage · 397B: crop hand regions with YOLO or a center heuristic, then tile the crops.",
