...
(function () {
  const I18N = {
    zh: {
      ...
      "world.p.inputs": "后文实验用到六类视觉输入：原始帧、时序拼贴、拼贴图、邻段拼贴、视觉提示叠加、手部裁剪。下图以同一片段（homer_4，22.9–26.8 秒，「拉开床头柜抽屉」）展示各自的画面组织形式。",
    ...
    en: {
      ...
      "world.p.inputs": "Later experiments use six visual-input formats: raw frames, a temporal collage, a contact sheet, a neighbor collage, a visual-hint overlay, and a hand crop. The examples below use the same span from homer_4 (22.9&ndash;26.8s, \"open the nightstand drawer\") to show how each format organizes the frames.",
