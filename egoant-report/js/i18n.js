...
(function () {
  const I18N = {
    zh: {
      ...
      "labelcmp.h2": "标注对照：人工标注与 EgoANT 管线",
      "labelcmp.lead": "上方播视频，下方两条时间轴；点击色块可查看该段标注并跳转播放。",
      "labelcmp.kicker": "标注对照",
    ...
    en: {
      ...
      "legend.ours": "EgoANT pipeline (candidate selector)",
      ...
      "labelcmp.h2": "Label comparison: human annotation vs EgoANT pipeline",
      "labelcmp.lead": "Video above, two timelines below; click a block to show that segment's label and jump playback.",
      "labelcmp.kicker": "Label comparison",
