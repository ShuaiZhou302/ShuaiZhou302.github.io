...
(function () {
  const I18N = {
    zh: {
      ...
      "world.zoo.proxy": "<strong>视觉提示叠加 / proxy overlay</strong>：在完整帧上叠加估计的腕部点与短时运动轨迹后提交。它提供手部运动线索，但不是人工标注，也不是直接裁剪手部区域。",
    ...
    en: {
      ...
      "world.zoo.proxy": "<strong>Visual-hint overlay / proxy overlay</strong>: estimated wrist points and short motion trails are drawn on the full frame before submission. This provides hand-motion cues, but it is not a human annotation and it does not crop the hand region.",
