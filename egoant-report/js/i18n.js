...
(function () {
  const I18N = {
    zh: {
      ...
      "story.seg.1": "腕速规则切段并合并：用 HaWoR 从视频重建手部运动并估计腕部速度曲线，在速度局部低谷处放置候选切点，再把过短的相邻段按时长规则合并。这与后文「S2 + 相邻片段规则合并」不同：后者是在 S2 预测上按标签/动词做离线合并。",
      ...
      "fig.src.wrist": "assets/explain/wrist_speed_oversegmentation_zh.svg?v=20260811-29",
    ...
    en: {
      ...
      "walk.prompt.sel": "Prompt (English only) — selector",
      "walk.prompt.judge": "Prompt (English only) — judge (scoring only)",
      "story.seg.1": "Wrist-speed rule cuts + merge: reconstruct hand motion with HaWoR, estimate the wrist-speed curve, place candidate cuts at local speed minima, then merge adjacent spans that are too short. This differs from later “S2 + adjacent-segment rule merges,” which offline-merge S2 predictions by label/verb rules.",
      "pipeline.wrist.fold": "Wrist-speed baseline pipeline",
      "pipeline.wrist.steps": "<div class=\"step\"><div class=\"n\">01</div><div class=\"t\">HaWoR</div><div class=\"d\">hand reconstruction to wrist tracks</div></div><div class=\"step\"><div class=\"n\">02</div><div class=\"t\">Smooth</div><div class=\"d\">filter wrist speed</div></div><div class=\"step\"><div class=\"n\">03</div><div class=\"t\">Cut</div><div class=\"d\">cut at speed minima</div></div><div class=\"step\"><div class=\"n\">04</div><div class=\"t\">Short-span merge</div><div class=\"d\">merge adjacent spans that are too short</div></div>",
      ...
      "fig.src.wrist": "assets/explain/wrist_speed_oversegmentation.svg?v=20260811-29",
