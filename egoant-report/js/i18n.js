...
(function () {
  const I18N = {
    zh: {
      ...
      "story.label.10": "HaWoR 手部裁剪 · 27B / 397B：用上文 HaWoR 腕轨迹裁剪；裁剪不完整时回退到原始帧。",
      ...
      "world.term.11": "HaWoR 腕轨迹裁剪<sup class=\"cite\"><a class=\"cite-ref\" href=\"#ref-hawor\">6</a></sup>：用 HaWoR 估计腕部轨迹并裁剪手部区域后提交；裁剪不完整时回退到原始帧。",
      ...
      "story.label.cap1": "读图（三栏）：左为原始帧；中为启发式框（画面中心偏下固定方框）；右为送给标注模型的裁剪图。该近似裁剪路径在固定边界上低于原始帧。见 <a href=\"#term-visual\">视觉输入</a>。",
    ...
    en: {
      ...
      "story.label.10": "HaWoR hand crop · 27B / 397B: use the HaWoR wrist-guided crop above; fall back to raw frames when crops are incomplete.",
      ...
      "world.term.11": "HaWoR wrist-guided crop<sup class=\"cite\"><a class=\"cite-ref\" href=\"#ref-hawor\">6</a></sup>: estimate wrist tracks with HaWoR, crop the hand region, and fall back to raw frames when crops are incomplete.",
      ...
      "story.label.cap1": "How to read (3 panels): left = raw frame; middle = heuristic box (fixed lower-center square); right = crop fed to the labeler. This approximate-crop path scores below raw frames on fixed bounds. See <a href=\"#term-visual\">visual inputs</a>.",
