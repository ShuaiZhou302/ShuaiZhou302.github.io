...
(function () {
  const I18N = {
    zh: {
      ...
      "world.p.inputs": "这一小节先把六类视觉输入各自「模型看见什么」做个概念预览，再用 HomER 里的一段样本（22.9–26.8 秒，「拉开床头柜抽屉」）对照实际画面。",
    ...
    en: {
      ...
      "world.p.inputs": "This subsection first previews what each of the six visual-input formats shows the model, then uses a HomER sample clip (22.9&ndash;26.8s, \"open the nightstand drawer\") for concrete frames.",
