...
(function () {
  const I18N = {
    zh: {
      ...
      "th.segf1": "视频分段得分",
      "story.label.p": "固定参考边界后，Gemini judge 全量重评显示：<strong>raw 27B 的观察值最高，为 55.7%</strong>；temporal collage 27B 为 52.8%，proxy overlay 27B 为 50.6%，基于 HaWoR 重建腕轨迹的手部裁剪（397B）为 50.9%，raw 397B 为 50.2%。新补的 27B 邻段拼贴为 40.9%，27B 近似手部拼贴为 38.5%；它们没有改变结论。需要区分两类手部输入：proxy hand-collage 是启发式近似裁剪，HaWoR wrist-guided crop 才读取重建腕轨迹。",
