...
(function () {
  const I18N = {
    zh: {
      ...
      "world.zoo.proxy": "<strong>视觉提示叠加</strong>：在完整画面上叠加区域提示后提交。提示框的具体生成方式将另文核对。",
      "world.zoo.crop": "<strong>手部裁剪</strong>：只把提示区域裁出后提交；与在完整画面上保留提示是两种不同输入。",
    ...
    en: {
      ...
      "world.zoo.proxy": "<strong>Visual-hint overlay</strong>: a region hint is overlaid on the full frame before submission. The exact hint-generation method will be checked separately.",
      "world.zoo.crop": "<strong>Hand crop</strong>: only the hinted region is cropped and submitted; this is distinct from keeping the hint on the full frame.",
