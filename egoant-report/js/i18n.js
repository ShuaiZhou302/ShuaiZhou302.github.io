...
(function () {
  const I18N = {
    zh: {
      ...
      "world.term.8": "<strong>覆盖完整动作（full-cover）</strong>：若窗口内完整出现了“拿起杯子”和“放下杯子”两个动作，模型应分别输出两段；仅出现伸手接近杯子或完成后收回手时，不单独输出片段。",
    ...
    en: {
      ...
      "world.term.8": "<strong>Cover full actions (full-cover)</strong>: if the window fully shows both \"pick up the cup\" and \"put down the cup,\" the model should output both segments. Merely reaching toward the cup or withdrawing the hand afterwards does not become a separate segment.",
