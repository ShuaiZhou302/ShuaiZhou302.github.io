...
(function () {
  const I18N = {
    zh: {
      ...
      "fig.src.segterms": "assets/explain/seg_terms_zh.svg?v=20260810-1",
      ...
      "world.zoo.note": "以上五张按管线参数重新渲染，用于说明差别本身。在固定边界的标注实验里，除 contact sheet 只用于分段外，其余四种都低于 raw；数字见 <a href=\"#story\">§7.2</a>。",
    ...
    en: {
      ...
      "fig.src.segterms": "assets/explain/seg_terms_en.svg?v=20260810-1",
      ...
      "world.zoo.note": "These five are re-rendered with the pipeline parameters to show the difference itself. In the fixed-boundary labeling experiments, all but the contact sheet (which is only used for segmentation) score below raw; numbers are in <a href=\"#story\">&sect;7.2</a>.",
