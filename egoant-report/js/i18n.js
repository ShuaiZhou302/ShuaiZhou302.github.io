...
(function () {
  const I18N = {
    zh: {
      ...
      "walk.flow.cap": "流程示意：左分段、右标注；原始帧可单路直出，也可与其他候选汇入判别器。",
      "pipeline.recipe.flow.cap": "图示流程：左分段、右标注；原始帧可单路直出，也可与其他候选一并送入判别器。",
      ...
      "tldr.h2": "TL;DR",
      "tldr.flow.cap": "流程总览：左分段、右标注；原始帧可单路直出，也可与其他候选一并送入判别器。",
      ...
      "walk.lead": "任务：用布擦桌面 / 柜面。下面按推荐路径逐步走一遍。",
      ...
      "walk.task": "任务：用布擦桌面 / 柜面。下面按推荐路径逐步走一遍。",
      "walk.s0.t": "输入视频",
      "walk.s1.t": "生成拼贴图",
    ...
    en: {
      ...
      "walk.flow.cap": "Flow sketch: segmentation left, labeling right; raw frames can go alone, or join other candidates into the selector.",
      "pipeline.recipe.flow.cap": "Flow: segmentation left, labeling right; raw frames can go alone, or join other candidates into the selector.",
      ...
      "tldr.h2": "TL;DR",
      "tldr.flow.cap": "Pipeline overview: segmentation on the left, labeling on the right; raw frames can go alone, or join other candidates into the selector.",
      ...
      "walk.lead": "Task: wipe a table / cabinet surface with a cloth. Below we walk the recommended path step by step.",
      ...
      "walk.task": "Task: wipe a table / cabinet surface with a cloth. Below we walk the recommended path step by step.",
