...
(function () {
  const I18N = {
    zh: {
      ...
      "walk.lead": "下列案例按第 3 章的推荐路径展示：先预测分段边界，再在固定预测边界下生成多个候选描述，并由候选判别器选出最终描述。任务：用布擦桌面 / 柜面。折叠区保留英语提示词原文。",
    ...
    en: {
      ...
      "walk.lead": "The case below follows the recommended path from Section 3: predict segment boundaries first, then generate multiple candidate descriptions on those predicted boundaries and let the candidate selector choose the final description. Task: wipe a table / cabinet surface with a cloth. Folded panels keep the original English prompts.",
