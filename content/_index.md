    ...
    content:
      ...
      text: |-
        ...
        <figure style="text-align: center; margin: 18px 0;">
          <img src="uploads/Research.png" alt="Projects diagram" style="max-width:100%;height:auto;display:inline-block;box-shadow:0 6px 18px rgba(0,0,0,0.25);border-radius:6px;" />
          <figcaption style="margin-top:8px;font-size:0.9rem;color:var(--text-muted,#9aa0a6);">(Generated by Nano Banana 🍌)</figcaption>
        </figure>

        <p style="font-size:0.9rem;color:#6b7280;font-style:italic;margin:8px 0;">Short Summary:</p>
        ...
        <p style="font-size:0.9rem;color:#6b7280;font-style:italic;margin:8px 0;">Previous Experience:</p>
        ...
        <figure style="text-align: center; margin: 18px 0;">
          ...
          <figcaption style="margin-top:8px;font-size:0.9rem;color:var(--text-muted,#9aa0a6);">Ongoing Cross-Embodiment Manipulation Project</figcaption>
        </figure>

        <p style="font-size:0.9rem;color:#6b7280;font-style:italic;margin:8px 0;">Looking Forward:</p>
